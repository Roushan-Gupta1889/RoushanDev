        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              <div className="absolute inset-0 rounded-3xl bg-secondary/50 border border-border overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-transparent" />
                {/* Abstract code visualization */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-6xl md:text-8xl font-display font-bold text-primary/20">
                    {"</>"}
                  </div>
                </div>
              </div>
              ...
              <motion.div
                ...
                className="absolute -right-4 top-1/4 glass-card p-3 glow-box"
              >
              ...
              <motion.div
                ...
                className="absolute -left-4 bottom-1/4 glass-card p-3 glow-box"
              >
                <div className="flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-primary" />
                  <span className="text-sm font-medium">Remote Ready</span>
                </div>
              </motion.div>
            </div>
          </motion.div>
