    ...
    <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-48 h-36 md:w-64 md:h-48">
          {/* Envelope body */}
          <motion.div
            className="absolute inset-0 bg-card border border-border/50 rounded-lg shadow-2xl overflow-hidden"
          ...
          >
            ...
            {/* @ Symbol on envelope */}
            <motion.div
              className="absolute top-1/2 left-4 md:left-6 -translate-y-1/2 w-8 h-8 md:w-10 md:h-10 bg-background/90 rounded-full flex items-center justify-center border border-border/30"
              animate={{
                scale: [1, 1, 0.9, 0.9, 1, 1],
                opacity: [1, 1, 0.7, 0.7, 1, 1],
              }}
              transition={{
                duration: animationDuration,
                repeat: Infinity,
          ...
          <motion.div
            ...
            initial={{ x: 140, y: 60, rotate: 0, scale: 1, opacity: 1 }}
            animate={{
              x: [140, 140, -80, -80, 140, 140],
              y: [60, 60, 180, 180, 60, 60],
              rotate: [0, 0, -45, -45, 0, 0],
              scale: [1, 1, 0.8, 0.8, 1, 1],
              opacity: [1, 1, 0.6, 0.6, 1, 1],
            }}
            transition={{
              duration: animationDuration,
              repeat: Infinity,
          ...
          >
            <svg viewBox="0 0 24 24" className="w-full h-full text-muted-foreground/80">
              <path
                fill="currentColor"
