    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden hero-gradient pt-20 md:pt-0">
      ...
      <div className="container-custom relative z-10 py-8 md:py-12 lg:py-0">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          {/* LEFT CONTENT */}
          <div className="text-center lg:text-left order-2 lg:order-1 mt-12 ">
            ...
            >
              I Build{" "}
              <span className="text-gradient inline-block min-w-[260px]">
                {displayText}
          ...
          <motion.div
            ...
            className="relative flex items-center justify-center order-1 lg:order-2 mt-12"
          >
            ...
            <div className="perspective-1000">
              <motion.div
                ...
                className="relative mt-8 md:mt-12 lg:mt-16 w-44 sm:w-56 md:w-64 lg:w-full lg:max-w-sm aspect-[2.2/3] group"
              >
